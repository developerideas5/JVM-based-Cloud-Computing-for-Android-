...
import com.android.paas.CalculatorOnCloud;
...
public class Main extends Activity 
{
    ...
    String EditTextMsg,hex_num,oct_num;
    String bin_num;
    ...
    public void onClickListenerPlus(View v)
    {
        ...
        if(sum != "")
        {
        	...
        	System.out.println("Second Value: " + Float.parseFloat(editText.getText().toString()));
        	
        	CalculatorOnCloud cloud = new CalculatorOnCloud();
        	result = Float.parseFloat(cloud.plus(result, Float.parseFloat(editText.getText().toString())).get(0));
    ...
    public void onClickListenerMinus(View v)
    {
        ...
        else if(sum != "")
        {
            if(result==0)
            {
            	System.out.println("First Value: "+Float.parseFloat(sum));
            	System.out.println("Second Value: " + result);
            	
            	CalculatorOnCloud cloud = new CalculatorOnCloud();
            	result = Float.parseFloat(cloud.minus(Float.parseFloat(sum),result).get(0));
            ...
            {
            	System.out.println("First Value: "+result);
            	System.out.println("Second Value: " + Float.parseFloat(sum));
            	
            	CalculatorOnCloud cloud = new CalculatorOnCloud();
            	result = Float.parseFloat(cloud.minus(result,Float.parseFloat(sum)).get(0));
    ...
    public void onClickListenerMultiply(View v)
    {
        ...
        if(sum !="")
        {
        	...
        	System.out.println("First Value: "+result_mul);
        	System.out.println("Second Value: " + floatEditTextMsg);
        	
        	CalculatorOnCloud cloud = new CalculatorOnCloud();
        	result = Float.parseFloat(cloud.minus(result_mul,floatEditTextMsg).get(0));
    ...
    public void onClickListenerDivide(View v)
    {
        ...
        if(sum !="" && result_div==1)
        {
            ...
            if(c==0)
            {
            	...
            	System.out.println("First Value: "+floatEditTextMsg);
            	System.out.println("Second Value: " +result_div );
            	
            	CalculatorOnCloud cloud = new CalculatorOnCloud();
            	result_div = Float.parseFloat(cloud.divide(floatEditTextMsg,result_div).get(0));
            ...
            {
            	System.out.println("First Value: "+result_div);
            	System.out.println("Second Value: " +floatEditTextMsg );
            	
            	CalculatorOnCloud cloud = new CalculatorOnCloud();
            	result_div = Float.parseFloat(cloud.divide(result_div,floatEditTextMsg).get(0));
    ...
    public void onClickListener_sin(View v)
    {
       ...
       afterSin = Double.parseDouble(cloud.sin(doubleEditTextMsg).get(0));
    ...
    public void onClickListener_cos(View v)
    {
        ...
        after_cos = Double.parseDouble(cloud.cos(doubleEditTextMsg).get(0));
    ...
    public void onClickListener_tan(View v)
    {
        ...
        CalculatorOnCloud cloud = new  CalculatorOnCloud();
         after_tan = Double.parseDouble(cloud.tan(doubleEditTextMsg).get(0));
    ...
    public void onClickListener_squared_2(View v)
    {
        ...
        CalculatorOnCloud cloud = new  CalculatorOnCloud();
         after_squared_2 = Double.parseDouble(cloud.square_2(doubleEditTextMsg).get(0));
    ...
    public void onClickListener_qube(View v)
    {
        ...
        CalculatorOnCloud cloud = new  CalculatorOnCloud();
         after_qube = Double.parseDouble(cloud.qube(doubleEditTextMsg).get(0));
     ...
     public void onClickListener_root(View v)
    {
        ...
        CalculatorOnCloud cloud = new  CalculatorOnCloud();
        after_root = Double.parseDouble(cloud.root(doubleEditTextMsg).get(0));
     ...
     public void onClickListener_dec(View v)
     {
         ...
         {           
        	  CalculatorOnCloud cloud = new  CalculatorOnCloud();
              dec_num = Integer.parseInt(cloud.dec(EditTextMsg).get(0));
     ...
     public void onClickListener_hex(View v)
     {
       ...
       //  Log.d("dec_num=",dec_num.toString());
        ...
        // hex_num=Integer.toHexString(dec_num);
         CalculatorOnCloud cloud = new  CalculatorOnCloud();
        hex_num = cloud.hex(EditTextMsg).get(0);
     ...
     public void onClickListener_oct(View v)
     {
         ...
         CalculatorOnCloud cloud = new  CalculatorOnCloud();
       oct_num = cloud.oct(EditTextMsg).get(0);
